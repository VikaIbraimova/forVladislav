package ex.view;
import ex.controller.DataExcelController;
...
public abstract class AbstractFrame extends JFrame {
    ...
    //Методы
    public List<String> getMyListResult() {
        return myListResult;
    }

    public AbstractFrame() throws HeadlessException, IOException {
        ...
        myListResult = new ArrayList<String>();
        int sizeMyList1 = 0;
